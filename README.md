...
|Motor Current             |0.18|
|Motor Voltage             |0.008|
|Battery Current           |3 m2|
|Battery Voltage           |1|
|Battery SOC               |7|  
|SPC velocity              |1|
|SPC efficiency, km/kWh    |250 kg|
|Remaining capacity        |200 kg|
|Remaining driving range   |2|
|Traveled distance         |2|
...
With the default parameters the SPC gives a 360 km range and an efficiency of 3.1 km/kWh. Both the range and the efficiency are influenced in the same way so only the offect of the variable on the range will be investigated
